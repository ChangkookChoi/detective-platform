...
홈페이지 후보를 다섯 차례에 걸쳐 추가 조사했고, 현재 14곳을 자동 수집 없이
...
1. 입력 준비를 재확인한 J&K·정의·원픽과 엠디탐정 본점·수원점의 공식
   원문을 등록 직전에 다시 확인하고, 유효한 후보만 주소별 수동 등록해
   브라우저 폼·중복 안내·감사 정보 표시 확인
2. 나머지 `manual_candidate`의 공식 원문·한 개 사무소·대표번호를 순차
   재확인하고 유효한 후보를 수동 등록
