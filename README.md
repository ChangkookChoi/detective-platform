...
구현했습니다. 공식 사무소 5곳을 추가 검수·승인해 현재 공개 업체는 총
6곳입니다. 이어 남은 수동 후보 10곳을 최신 공식 원문으로 다시 걸러 8곳을
비공개 고위험 검수 후보로 등록했고, 현재 접근 실패·주소 충돌이 있는 2곳은
등록하지 않았습니다. 운영 DB와 배포는 아직 준비 전입니다. 최신 진행 상황은
