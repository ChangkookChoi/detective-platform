...
현재 저장소는 **핵심 MVP 기능 구현 단계**입니다. PostgreSQL 초기 스키마·migration·seed, 공개 업체 검색·상세, 관리자 검수와 개인정보 최소화 일별 분석 집계를 구현했습니다. 실제 업체 데이터, 지속형 개발·운영 DB와 운영 배포는 아직 준비 전입니다. 최신 진행 상황은 [docs/STATUS.md](docs/STATUS.md)를 기준으로 확인합니다.
